...
const modals = (function () {
    ...
    saveProjectBtn.onclick = function () {
        _storage_js__WEBPACK_IMPORTED_MODULE_0__.editProject(_storage_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProjectId(), editProjectName.value, editProjectColor.value)
        close()
        renderPage()
    }
...
function loadProjects() {
    ...
    projects.forEach(project => {
        const newProject = new _app__WEBPACK_IMPORTED_MODULE_0__.Project(project.name, project.color, project.id)
        project.tasks.forEach(task => {
            newProject.tasks.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Task(task.title, task.description, task.priority, task.dueDate))
        })
...
function setProject(name, color) {
    projects.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Project(name, color));
}
...
function getDefaultProjects() {
    const projects = []
    projects.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Project("Inbox", null, "0"));
    projects.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Project("Today", null, "1"));
    projects.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Project("Upcoming", null, "2"));
    return projects
}

function setTask(title, description, priority, dueDate) {
    projects.forEach(project => {
        if (project.id === getSelectedProjectId()) {
            project.tasks.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Task(title, description, priority, dueDate))
        }
    })
}
