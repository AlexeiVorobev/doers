...
const newProjectForm = (function () {
    ...
    form.addEventListener('submit', e => {
        ...
        ;(0,_app_js__WEBPACK_IMPORTED_MODULE_0__.setProject)(projectName, projectColor)
        renderProjects();
        close()
    })
