...
function renderInbox() {
    ...
    renderTasks(_storage_js__WEBPACK_IMPORTED_MODULE_0__.getInboxProject());
    content.appendChild(createAddTaskBtn());
}

function renderProject(id = _storage_js__WEBPACK_IMPORTED_MODULE_0__.getSelectedProjectId()) {
...
/* harmony export */   "getInboxProject": () => (/* binding */ getInboxProject),
