    ...
    projects.forEach((project) => {
        ...
        project.tasks.forEach((task) => {
            newProject.tasks.push(
                new _app__WEBPACK_IMPORTED_MODULE_0__.Task(
                    task.title,
                    task.description,
                    task.priority,
                    task.dueDate,
...
function getDefaultProjects() {
    ...
    projects.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Project("This week", null, "2"));
    return projects;
}
...
function setTask(title, description, priority, dueDate, id) {
    projects.forEach((project) => {
        if (project.id === getSelectedProjectId()) {
            project.tasks.push(new _app__WEBPACK_IMPORTED_MODULE_0__.Task(title, description, priority, dueDate, id));
        }
    });
}
